...
let editignIndex: number | null = null;
// Get DOM elements
const bookTitleInput = document.getElementById("bookTitle") as HTMLInputElement;
const bookAuthorInput = document.getElementById(
  "bookAuthor"
) as HTMLInputElement;
const addBookButton = document.getElementById("addBook") as HTMLButtonElement;

const memberNameInput = document.getElementById(
  "memberName"
) as HTMLInputElement;
const memberEmailInput = document.getElementById(
  "memberEmail"
) as HTMLInputElement;
const memberPhoneInput = document.getElementById(
  "memberPhone"
) as HTMLInputElement;
...
const borrowMemberSelect = document.getElementById(
  "borrowMember"
) as HTMLSelectElement;
const borrowBookSelect = document.getElementById(
  "borrowBook"
) as HTMLSelectElement;
const borrowButton = document.getElementById(
  "borrowBookButton"
) as HTMLButtonElement;
const returnBookButton = document.getElementById(
  "returnBook"
) as HTMLButtonElement;
const returnMemberSelect = document.getElementById(
  "returnMember"
) as HTMLSelectElement;
const returnBookMember = document.getElementById(
  "returnBookMember"
) as HTMLSelectElement;
  ...
  books.forEach((book, index) => {
    ...
    editButton.addEventListener("click", () => {
      ...
      const existingBook = books.find(
        (b) => b.title === upadeBook.title && b.author === upadeBook.author
      );
      if (existingBook) {
        alert("Book already exists");
        return;
...
const addMember = () => {
  ...
  if (
    members.some(
      (member) =>
        member.email === newMember.email || member.phone === newMember.phone
    )
  ) {
...
const borrowBook = (memberId: number, bookId: number) => {
...
let membersWhoHaveBorrowed: Member[] = [];
const returnMemberDropdown = () => {
  membersWhoHaveBorrowed = members.filter((member) =>
    borrowedBooks.some((book) => book.borrowedBy === member.id)
  );
...
// array to store members who have borrowed a book
let booksWhichHaveBeenBorrowed: Book[] = [];
const returnBookMemberDropdown = () => {
  booksWhichHaveBeenBorrowed = books.filter(
...
const returnBook = (bookId: number, memberId: number) => {
